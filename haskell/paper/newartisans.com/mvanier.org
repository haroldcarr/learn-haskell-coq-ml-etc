...
Last Modified : 2013 Oct 18 (Fri) 16:41:47 by carr.
...
{-
t13 = t "s1"
      [stateExampleMonadic shiftM upperM (return "hello world")
      ]
      ("!E","llo world")

:t stateExampleMonadic
:t stateExampleMonadic shiftM
:t stateExampleMonadic shiftM upperM
-}
#+END_SRC
...
#+BEGIN_SRC haskell
main = do
    runTestTT $ TestList $ t1 ++ t2 ++ t3 ++ t4 ++ t5 ++ t6 ++ t7 ++ t8 ++ t9 ++ t10 ++ t11 ++ t12
#+END_SRC
