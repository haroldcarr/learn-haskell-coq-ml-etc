...
Last Modified : 2013 Oct 18 (Fri) 19:28:28 by carr.
...
stateExampleMonadic :: (String -> State String Char) -> (String -> State String Char) -> String -> State String [Char]
stateExampleMonadic f1 f2 x =
    get          >>=
    \s0 -> f1 s0 >>=
    \r1 -> get   >>=
    \s1 -> f2 s1 >>=
...
t13 = t "s1"
      [(runState (stateExampleMonadic shiftM upperM (return 'c'))) "hello world"
      ]
      ("!E","llo world")
#+END_SRC
