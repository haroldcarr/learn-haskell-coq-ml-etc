...
Last Modified : 2014 Mar 20 (Thu) 10:19:56 by Harold Carr.
-}
...
parseResponseTests = TestList
    [teq "parseResponse expand" ((Right (parseResponse expandResponseTestData)) :: Either String (Either String DataStatusCodeStatusTxt))
                                 ((Right (Right (DSCST {ddata = ExpandResponseData {expand = [ExpandResponse {er_short_url = Just "http://bit.ly/LCJq0b", er_long_url = Just "http://blog.swisstech.net/2012/06/local-postfix-as-relay-to-amazon-ses.html", er_user_hash = Just "LCJq0b", er_global_hash = Just "LCJsVy", er_hash = Nothing, er_error = Nothing},ExpandResponse {er_short_url = Just "http://bit.ly/phphotoCrossroads", er_long_url = Just "http://500px.com/photo/8337350", er_user_hash = Just "KShcAV", er_global_hash = Just "KShcAW", er_hash = Nothing, er_error = Nothing},ExpandResponse {er_short_url = Just "http://bit.ly/springFever", er_long_url = Just "http://500px.com/photo/5802359", er_user_hash = Just "MbmhB4", er_global_hash = Just "MbmhB5", er_hash = Nothing, er_error = Nothing},ExpandResponse {er_short_url = Just "http://bit.ly/phphotoBenched", er_long_url = Just "http://500px.com/photo/8247630", er_user_hash = Just "LqVZLZ", er_global_hash = Just "LqW02c", er_hash = Nothing, er_error = Nothing},ExpandResponse {er_short_url = Just "http://bit.ly/Lt5SJo", er_long_url = Just "http://www.bieberphoto.com/index.php/2012/05/15/automating-mass-portraits-with-qr-codes/", er_user_hash = Just "Lt5SJo", er_global_hash = Just "JPNM5X", er_hash = Nothing, er_error = Nothing},ExpandResponse {er_short_url = Nothing, er_long_url = Just "https://github.com/stackmagic/bitly-api-client", er_user_hash = Just "LfXpbF", er_global_hash = Just "LfXpbG", er_hash = Just "api-client", er_error = Nothing},ExpandResponse {er_short_url = Nothing, er_long_url = Just "http://500px.com/photo/7998374", er_user_hash = Just "LjTbAy", er_global_hash = Just "LjTbAz", er_hash = Just "phphotoWinterSunII", er_error = Nothing},ExpandResponse {er_short_url = Nothing, er_long_url = Just "http://500px.com/photo/7980928", er_user_hash = Just "JYROvi", er_global_hash = Just "JYROvj", er_hash = Just "phphotoQuoVadis", er_error = Nothing},ExpandResponse {er_short_url = Nothing, er_long_url = Just "http://500px.com/photo/7968427", er_user_hash = Just "KmfxWg", er_global_hash = Just "KmfxWh", er_hash = Just "phphotoDock3", er_error = Nothing},ExpandResponse {er_short_url = Nothing, er_long_url = Just "http://500px.com/photo/7010618", er_user_hash = Just "LlyMLt", er_global_hash = Just "LlyN1G", er_hash = Just "phphotoZueriWest", er_error = Nothing}]}, status_code = 200, status_txt = "OK"}))) :: Either String (Either String DataStatusCodeStatusTxt))
