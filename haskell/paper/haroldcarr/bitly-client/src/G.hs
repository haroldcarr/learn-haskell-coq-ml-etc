...
Last Modified : 2014 Mar 15 (Sat) 21:42:25 by Harold Carr.
...
convertTyp                                 t@(TyList (TyCon (UnQual (Ident i)))) = t
convertTyp                                         t@(TyCon (UnQual (Ident i)))  = t
convertTyp t@(TyApp (TyCon (UnQual (Ident "Maybe"))) (TyCon (UnQual (Ident i)))) = t
