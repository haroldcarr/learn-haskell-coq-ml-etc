...
Use the `forall` keyword in Rank-n function types to indicate nested parametric polymorphism.

Universal quantification is the implicit default pattern when parameterizing types with types.
...
Existential quantification enables encapsulation.
