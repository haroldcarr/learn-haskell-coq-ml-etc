...
Last Modified : 2013 Oct 30 (Wed) 17:53:52 by carr.
-}
...
tests = TestList
    ...
    ,teq "from"                            (from game [(startBlock game, [])] [])
...
{- TODO
    ,teq "pathsFromStart" (pathsFromStart game)
...
-}
    ...
    ,teq "optimal solution for game 1"        (solve game         (solution game))         (Block (goal game)         (goal game))
    ,teq "optimal solution length for game 1" (Prelude.length     (solution game))         (Prelude.length optsolution)
